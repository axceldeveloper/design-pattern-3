...
import com.example.patterns_banking.models.decorator.AccountWithdrawalLimitDecorator;
...
public class WithdrawCommand implements ICommand<Account> {
    ...
    public Account execute() {
        ...
        AccountWithdrawalLimitDecorator accountDec = new AccountWithdrawalLimitDecorator(account);
